...
def send_email_with_thread(subject, message, to, email_lock) -> None:
...
def send_email(subject, message, to, email_lock) -> None:
...
def send_email_for_user_sign_up(ischair, to, email_lock) -> None:
    if ischair:
